...
#function to create models, if 'lr' for linear regression,
# 'svm' for svm which is followed by either 'default' or a specific value for 'C'
def createModel(modelType,*c):
    ...
    if modelType == 'svm':
        ...
        # Regression chart
        chart_regression(y_pred[:100].flatten(), y_validate[:100], sort=True)
